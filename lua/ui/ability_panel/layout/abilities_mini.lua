...
function SetLayout()
    ...
    controls.orderButtonGrid.Width:Set(LayoutHelpers.ScaleNumber(GameCommon.iconWidth) * horzCols)
    controls.orderButtonGrid.Height:Set(LayoutHelpers.ScaleNumber(GameCommon.iconHeight) * horzRows)
